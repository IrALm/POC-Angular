  ...
  // ─── Public routes ──────────────────────────────────────────
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/auth/google-role-selection/google-role-selection').then(m => m.GoogleRoleSelectionComponent),
      },
    ],
  },
  ...
  // ─── Espace Propriétaire ────────────────────────────────────
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadComponent: () =>
          import('./features/biens/bien-edit/bien-edit').then(m => m.BienEditComponent),
      },
      {
        path: 'biens',
        loadComponent: () =>
